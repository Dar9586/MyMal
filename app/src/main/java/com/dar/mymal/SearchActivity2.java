...
import com.dar.mymal.entries.searches.*;
...
public class SearchActivity2 extends AppCompatActivity {
    ...
    void makeSearch(String query){
        ...
        View s[]=new View[5];
        for(int a=0;a<5;a++)s[a]=mSectionsPagerAdapter.getRegisteredFragment(a).getView();
        new MasterSearch(query,s,this);
    }

    @Override
    public boolean onCreateOptionsMenu(Menu menu) {
        // Inflate the menu; this adds items to the action bar if it is present.
        getMenuInflater().inflate(R.menu.menu_search_activity2, menu);
        return true;
    }
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
            View rootView = inflater.inflate(R.layout.void_recycler, container, false);

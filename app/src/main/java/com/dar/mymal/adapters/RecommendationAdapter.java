...
public class RecommendationAdapter extends RecyclerView.Adapter<RecommendationAdapter.ViewHolder> {
    ...
    public RecommendationAdapter(Context cont, boolean useLessData, List<String> files, int subMenu) {
        this.context=cont;
        this.useLessData=useLessData;
        this.files=files;
        this.subMenu=subMenu;
    }
    public RecommendationAdapter(Context cont, Recommendations myDataset, boolean useLessData, List<String> files) {
        this.context=cont;
    ...
    public void onBindViewHolder(final ViewHolder holder, final int posit) {
        ...
        final Recommendation ent=mDataset.getRec().get(pos);
